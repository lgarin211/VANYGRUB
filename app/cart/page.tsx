      ...
      <header className="py-4 text-white bg-red-800">
        <div className="container flex items-center justify-between px-4 mx-auto">
          ...
          <div className="flex space-x-4">
            <Link href="/cart" className="relative flex items-center px-4 py-2 space-x-2 text-yellow-300 transition-all duration-300 bg-white/10 rounded-lg">
              ...
              {cartItems.length > 0 && (
                <span className="flex items-center justify-center w-5 h-5 text-xs font-bold text-red-800 bg-yellow-400 rounded-full">
                  {cartItems.reduce((sum, item) => sum + item.quantity, 0)}
                </span>
              )}
            </Link>
            <button className="relative flex items-center px-4 py-2 space-x-2 transition-all duration-300 rounded-lg hover:bg-white/10">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <div className="flex items-start justify-between">
                            <div>
                              <h3 className="text-lg font-semibold text-gray-900 mb-1">
                                <Link href={`/product/${item.id}`} className="hover:text-red-600">
                                  {item.name}
                                </Link>
                              </h3>
