      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center justify-center min-h-[70vh]">
          <div className="text-center max-w-md mx-auto p-8">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Memuat Data Pesanan</h2>
        ...
        <div className="flex items-center justify-center min-h-[70vh]">
          <div className="text-center max-w-lg mx-auto p-8 bg-white rounded-2xl shadow-lg">
            ...
            <div className="bg-gray-100 rounded-lg p-4 mb-6">
              <code className="text-xl font-mono font-bold text-red-600">{orderCode}</code>
            </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex flex-col sm:flex-row sm:justify-between gap-1 sm:gap-0">
                    <span className="text-gray-700 font-medium">Kode Pesanan:</span>
                    <div className="font-mono text-sm bg-red-100 text-red-800 px-4 py-2 rounded-lg font-bold border border-red-200">
                      {orderData.orderCode}
                    </div>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between gap-1 sm:gap-0">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex flex-col sm:flex-row sm:justify-between">
                    ...
                    <span className="text-gray-900 font-semibold">{orderData.customerInfo.name}</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between">
                    <span className="text-gray-700 font-medium">Phone:</span> 
                    <span className="text-gray-900 font-semibold">{orderData.customerInfo.phone}</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between">
                    <span className="text-gray-700 font-medium">Email:</span> 
                    <span className="text-gray-900 font-semibold break-all">{orderData.customerInfo.email}</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between">
                    <span className="text-gray-700 font-medium">Alamat:</span> 
                    <span className="text-gray-900 font-semibold text-right sm:max-w-xs break-words">{orderData.customerInfo.address}</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between">
                    <span className="text-gray-700 font-medium">Kota:</span> 
                    <span className="text-gray-900 font-semibold">{orderData.customerInfo.city}</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between">
                    <span className="text-gray-700 font-medium">Kode Pos:</span> 
                    <span className="text-gray-900 font-semibold">{orderData.customerInfo.postalCode}</span>
                  </div>
                  {orderData.customerInfo.notes && (
                    <div className="mt-4 p-3 bg-blue-50 rounded-lg border-l-4 border-blue-400">
                      <span className="text-gray-700 font-medium">Catatan:</span>
                      <p className="text-gray-900 font-semibold mt-1">{orderData.customerInfo.notes}</p>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className="px-8 py-6">
            ...
            <div className="space-y-4">
              {orderData.items.map((item: CartItem, index: number) => (
                <div key={index} className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      <div>
                        <span className="text-gray-600 font-medium">Warna:</span>
                        <span className="ml-1 text-gray-900 font-semibold">{item.color}</span>
                      </div>
                      <div>
                        <span className="text-gray-600 font-medium">Ukuran:</span>
                        <span className="ml-1 text-gray-900 font-semibold">{item.size}</span>
                      </div>
                    </div>
                  </div>
                  <div className="flex flex-row sm:flex-col gap-4 sm:gap-0 w-full sm:w-auto">
                    <div className="flex-1 sm:flex-none text-center sm:mb-2">
                      <div className="text-xs text-gray-600 font-medium">Quantity</div>
                      <div className="font-bold text-lg text-gray-900">{item.quantity}x</div>
                    </div>
                    <div className="flex-1 sm:flex-none text-center sm:mb-2">
                      <div className="text-xs text-gray-600 font-medium">Harga Satuan</div>
                      <div className="font-bold text-red-600">{item.price}</div>
                    </div>
                    <div className="flex-1 sm:flex-none text-center">
                      <div className="text-xs text-gray-600 font-medium">Subtotal</div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-2">
                    ...
                    <span className="font-bold text-lg text-gray-900">{formatPrice(orderData.pricing.subtotal)}</span>
                  </div>
                  ...
                  <div className="flex justify-between items-center py-2">
                    <span className="text-gray-700 font-medium">Pajak (PPN 10%)</span>
              ...
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                ...
                <div className="text-sm space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-gray-900">WhatsApp: +62 821-1142-4592</span>
                  </div>
                  <div className="flex items-center gap-2">
