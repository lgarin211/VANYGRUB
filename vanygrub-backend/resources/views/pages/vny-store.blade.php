  ...
  <nav class="border-t border-red-400/30">
    <div class="px-5 mx-auto max-w-7xl">
      <ul class="flex items-center justify-center">
        ...
        <li>
          <a href="{{ route('vny.product') }}" class="block px-6 py-3 text-sm font-medium text-white transition-colors duration-200 hover:bg-white/10">PRODUCT</a>
        </li>
        <li>
          <a href="#" class="block px-6 py-3 text-sm font-medium text-white transition-colors duration-200 hover:bg-white/10">ABOUT VNY</a>
        </li>
        <li>
          <a href="#" class="block px-6 py-3 text-sm font-medium text-white border-b-2 border-white bg-white/20">GALLERY</a>
        </li>
      </ul>
    </div>
  </nav>
